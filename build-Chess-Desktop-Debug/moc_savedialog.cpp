...
#include "../ICP/src/views/savedialog.h"
...
QT_MOC_LITERAL(3, 30, 21) // "on_saveButton_clicked"
    ...
    "SaveDialog\0saveButtonClicked\0\0"
...
void SaveDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SaveDialog::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SaveDialog::saveButtonClicked)) {
                *result = 0;
                return;
            }
        }
